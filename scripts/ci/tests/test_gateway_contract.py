...
class GatewayContractTests(unittest.TestCase):
    ...
    def test_metadata_and_code_are_published_atomically_by_trusted_builder(self):
        self.assertIn('scripts/local_ci/integration/build_task_metadata.py', self.dispatch)
        self.assertIn('${WORKER_REVISION_SHA}:scripts/local_ci/integration/build_task_metadata.py', self.dispatch)
    ...
    def test_receiver_uses_task_path_and_forwards_task_identity(self):
        self.assertIn('scripts/local_ci/integration/receive_result.py', self.receive)
